...
LICENSE_third_party/webdriver = "Apache-2.0 & MIT & GPLv2"
...
LIC_FILES_CHKSUM = "\
    ...
    file://${S}/native_client_sdk/src/build_tools/sdk_tools/third_party/fancy_urllib/README.chromium;md5=f0640d0d893896c778eb2a49a41de3c2 \
...
do_install() {
    ...
    install -d ${D}${libdir}/xwalk/lib/
    install -m 0644 ${S}/out/Release/lib/libffmpeg.so ${D}${libdir}/xwalk/lib/libffmpeg.so
    install -m 0644 ${S}/out/Release/*.pak ${D}${libdir}/xwalk/
    if [ -f ${S}/out/Release/natives_blob.bin ]; then
        install -m 0644 ${S}/out/Release/natives_blob.bin ${D}${libdir}/xwalk/
        install -m 0644 ${S}/out/Release/snapshot_blob.bin ${D}${libdir}/xwalk/
    fi
    cp -a --no-preserve=ownership ${S}/out/Release/locales ${D}${libdir}/xwalk/
    find ${D}${libdir}/xwalk/locales -type f -exec chmod 644 {} \;
    find ${D}${libdir}/xwalk/locales -type d -exec chmod 755 {} \;
